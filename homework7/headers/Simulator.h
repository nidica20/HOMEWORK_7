...
public:
	...
	void show_stats()
	{
		...
		double average_landing_time = (landing_queue->get_total_wait() / landing_queue->get_num_served() );
		std::cout << "The average wait time for the landing/arrival queue is: " << average_landing_time << std::endl;
		...
		double average_departure_time = (departure_queue->get_total_wait() / departure_queue->get_num_served() );
		std::cout << "The average wait time for departure queue is: " << average_departure_time << std::endl;
